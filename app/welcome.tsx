...
const WelcomeScreen = () => {
  ...
  return (
    <View style={styles.welcome}>
      ...
      <Text style={{ fontSize: fontSizes.xxl, fontWeight: fontWeights.bold }}>
        unFit
      </Text>
      ...
      <Text style={{ textAlign: "center", opacity: opacity.md }}>
        unFit is a lightweight workout tracker designed to record your progress
        as quick as you can open the app.
      </Text>
